...
exist_pairs = os.listdir(caption_dir)
print("original deleted count",len(deleted_pairs))

for pair in saved_pairs:
    if f"{pair}.txt" in exist_pairs:
        continue
    # pair not exist in captions folder
    deleted_pairs.append(pair)

print("updated deleted count",len(deleted_pairs))
